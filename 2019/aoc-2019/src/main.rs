...
fn get_day(n: i32) -> Result<Box<dyn Day>> {
    match n {
        ...
        12 => {
            return Ok(Box::new(Day12{}));
        },
        13 => {
            return Ok(Box::new(Day13{}));
        },
        14 => {
            return Ok(Box::new(Day14{}));
        },
        15 => {
            return Ok(Box::new(Day15{}));
        },
        16 => {
            return Ok(Box::new(Day16{}));
        },
        17 => {
            return Ok(Box::new(Day17{}));
        },
        18 => {
            return Ok(Box::new(Day18{}));
        },
        19 => {
            return Ok(Box::new(Day19{}));
        },
        20 => {
            return Ok(Box::new(Day20{}));
        },
        21 => {
            return Ok(Box::new(Day21{}));
        },
        22 => {
            return Ok(Box::new(Day22{}));
        },
        23 => {
            return Ok(Box::new(Day23{}));
        },
        24 => {
            return Ok(Box::new(Day24{}));
        },
        25 => {
            return Ok(Box::new(Day25{}));
        },
        _ => {
